      ...
      <div className={classes.flexBox} data-aos="zoom-out-up" data-aos-duration="1000">
        <div className={classes.aboutSideImg}>
          <img
            ...
            alt="Boy Image Doing Video Editing"
          />
        </div>
        <div className={classes.aboutText}>
          ...
          <p>
            ...
            services. Elevate your videos to cash-generating assets. Contact us
            today for seamless captivating results.
          </p>
          <p>
            We specialize in editing a wide range of cash cow videos, including:
          </p>
